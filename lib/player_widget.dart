...
import 'package:newsApp/voice_connection.dart';
...
class _PlayerWidgetState extends State<PlayerWidget> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        SizedBox(height: 60.0, width: 60.0, child: CircularProgressIndicator(
          ...
          value: (
            ...
            _position.inMilliseconds < _duration.inMilliseconds) ? _position.inMilliseconds/_duration.inMilliseconds : 0.0,
          )
        ),
        IconButton(
          icon: _isPlaying ? Icon(Icons.pause, color: Colors.black, size: 45.0) : Icon(Icons.play_arrow, color: Colors.black, size: 45.0), 
          onPressed: (){
  ...
  Future<int> _play(String body) async {
    ...
    var response = await voiceResponse(body); // we created earlier
